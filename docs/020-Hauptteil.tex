...
ergänzt. Hier werden mehrere Antwortarten und Imputationen unterschieden:
...
wird automatisch maybe/notsure zugewiesen 
    \item Frage 41: sollten eigentlich zwei vordefinierte Werte sein - male, female
aber jeder hat freien text geschrieben und es sind antworten gekommen wie "f", "cis man"
"none of your business", deswegen bevor die fehlenden werte imputiert werden, müssen
die antworten vereinheitlicht werden
