...
UK, USA, bisschen auch Kanada
    ...
    \item 7 spalten die ordinal encodiert wurden, wieder entskalieren und decodieren
    \item RELATIVE FIRMENGRÖßE:
    \item CLUSTER 0: zum großteil 1-5, bisschen 6-25 und über 1000
    \item CLUSTER 1: hauptächlicht 1-5, bisschen 6-25 und über 1000
    \item CLUSTER 2: hauptsächlich 1-5 UND über 1000, weniger 6-25
    \item RELATIV ALTER:
    \item CLUSTER 0: huptsächlich 17-25
    \item CLUSTER 1: hauptsächlich 17-25
    \item CLUSTER 2: großteil 17-25 aber auch 56-67
    \item RELATIVE REMOTE WORK:
    \item CLUSTER 0: hauptsächlich niemals, aber viele auch immer/manchmal
    \item CLUSTER 1: hauptsächlich niemals, aber viele auch immer/manchmal
    \item CLUSTER 2: hauptsächlich immer, viele manchmal, wenige niemals
    \item MEDICAL LEAVE FROM WORK:
    \item CLUSTER 0: hauptsächlich sehr schwer
    \item CLUSTER 1: sehr ähnlich
    \item CLUSTER 2: sehr schwer/idk
    \item über MH DER FAMILIE/FREUNDEN ERZÄHLEN:
    \item CLUSTER 0: lieber nicht
    \item CLUSTER 1: lieber nicht
    \item CLUSTER 2: lieber nicht/betrifft mich nicht, und sehr offen
    \item Probleme bei Arbeit wenn gut behandelt:
    \item CLUSTER 0: niemals, manche manchmal
    \item CLUSTER 1: niemals/manchmal
    \item CLUSTER 2: niemals
    \item Probleme bei Arbeit wenn NICHT gut behandelt:
    \item CLUSTER 0: niemals, manche manchmal
    \item CLUSTER 1: niemals/manchmal, viele keine MH
    \item CLUSTER 2: niemals/manchmal, aber großteil keine MH
\end{itemize}
